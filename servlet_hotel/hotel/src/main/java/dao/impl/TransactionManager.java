...
public class TransactionManager {
    ...
    static void beginTransaction(Connection connection) {
        try {
    ...
    static void commitTransaction(Connection connection) {
        try {
    ...
    static void rollbackTransaction(Connection connection){
        try{
